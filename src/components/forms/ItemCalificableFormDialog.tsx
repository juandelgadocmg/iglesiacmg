...
export default function ItemCalificableFormDialog({ corteId, materiaId }: Props) {
  ...
  const form = useForm({
    ...
    defaultValues: { nombre: "", tipo: "Clase", porcentaje: undefined as number | undefined, fecha_inicio: "", fecha_fin: "" },
  });

  const onSubmit = async (values: { nombre: string; tipo: string; porcentaje?: number; fecha_inicio?: string; fecha_fin?: string }) => {
    try {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader><DialogTitle>Nuevo Ítem Calificable</DialogTitle></DialogHeader>
        <Form {...form}>
